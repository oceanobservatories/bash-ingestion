...
INGESTLOG=/home/wdk/race/log/new-ingest-wfp-CP02PMUI.log
#INGESTLOGT=/home/developer/ingest_initial/log/com1.log
INGESTLOGT=/home/wdk/race/log/new-ingest-wfp-CP02PMUI.log-T
...
date
echo "starting new-ingest-wfp-CP02PMUI.sh"

#files of the type
MCI_DAT_a=/omc_data/whoi/OMC/CP02PMUI/D00003/imm/adcpt/adcpt_*_*.DAT 
MCI_DEC_A=/omc_data/whoi/OMC/CP02PMUI/D00003/imm/mmp/A*.DEC 
MCI_DAT_C=/omc_data/whoi/OMC/CP02PMUI/D00003/imm/mmp/C*.DAT  
MCI_DAT_E=/omc_data/whoi/OMC/CP02PMUI/D00003/imm/mmp/E*.DAT 

MCI_log=/omc_data/whoi/OMC/CP02PMUI/D00003/3dmgx3/*_*.3dmgx3.log 
MCI_txt=/omc_data/whoi/OMC/CP02PMUI/D00003/irid2shore/stc_status.*_*.txt
...
do
	...
	ls -l $f_a
	echo $INGS Ingest.adcps-jln-stc_telemetered $f_a CP02PMUI-RII01-01-ADCPTG000 telemetered
	     $INGS Ingest.adcps-jln-stc_telemetered $f_a CP02PMUI-RII01-01-ADCPTG000 telemetered 
    fi
done
...
do
	...
	ls -l $f_A
	echo $INGS Ingest.vel3d-k-wfp-stc_telemetered $f_A CP02PMUI-WFP01-01-VEL3DK000 telemetered
	     $INGS Ingest.vel3d-k-wfp-stc_telemetered $f_A CP02PMUI-WFP01-01-VEL3DK000 telemetered
    fi
done
...
do
	...
	ls -l $f_C
	echo $INGS Ingest.ctdpf-ckl-wfp_telemetered $f_C CP02PMUI-WFP01-03-CTDPFK000 telemetered
	     $INGS Ingest.ctdpf-ckl-wfp_telemetered $f_C CP02PMUI-WFP01-03-CTDPFK000 telemetered
	echo $INGS Ingest.dofst-k-wfp_telemetered $f_C CP02PMUI-WFP01-02-DOFSTK000 telemetered
	     $INGS Ingest.dofst-k-wfp_telemetered $f_C CP02PMUI-WFP01-02-DOFSTK000 telemetered
    fi
done
...
do
	...
	ls -l $f_E
	echo $INGS Ingest.wfp-eng-stc-imodem_telemetered $f_E CP02PMUI-WFP01-00-STCENG000 telemetered
		 $INGS Ingest.wfp-eng-stc-imodem_telemetered $f_E CP02PMUI-WFP01-00-STCENG000 telemetered
	echo $INGS Ingest.flort-kn-stc-imodem_telemetered $f_E CP02PMUI-WFP01-04-FLORTK000 telemetered
	     $INGS Ingest.flort-kn-stc-imodem_telemetered $f_E CP02PMUI-WFP01-04-FLORTK000 telemetered
	echo $INGS Ingest.parad-k-stc-imodem_telemetered $f_E CP02PMUI-WFP01-05-PARADK000 telemetered
	     $INGS Ingest.parad-k-stc-imodem_telemetered $f_E CP02PMUI-WFP01-05-PARADK000 telemetered 
    fi
done
...
do
	...
	ls -l $f_l
	echo $INGS Ingest.mopak-o-dcl_telemetered $f_l CP02PMUI-SBS01-01-MOPAK0000 telemetered
	     $INGS Ingest.mopak-o-dcl_telemetered $f_l CP02PMUI-SBS01-01-MOPAK0000 telemetered
    fi
done
...
do
	...
	ls -l $f_t
	echo $INGS Ingest.cg-stc-eng-stc_telemetered $f_t CP02PMUI-SBS01-00-STCENG000 telemetered
	     $INGS Ingest.cg-stc-eng-stc_telemetered $f_t CP02PMUI-SBS01-00-STCENG000 telemetered
    fi
done

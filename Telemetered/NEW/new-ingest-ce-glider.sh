...
#
GL1D2_files=$(find $GL1D2 -mmin -60 -print)
# $(find $GL1D2 -mtime -14 -print)
#
GL2D2_files=$(find $GL2D2 -mmin -60 -print)
# $(find $GL2D2 -mtime -14 -print)
#
GL3D2_files=$(find $GL3D2 -mmin -60 -print)
# $(find $GL3D2 -mtime -14 -print)

GL4D1_files=$(find $GL4D1 -mmin -60 -print)
# $(find $GL4D1 -mtime -14 -print)
#
GL5D1_files=$(find $GL5D1 -mmin -60 -print)

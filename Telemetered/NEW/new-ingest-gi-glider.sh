...
# Ingest.glider-eng-glider_telemetered   /omc_data/whoi/OMC/GI05MOAS-GL001/D00001/merged-from-glider/cp_469_*.mrg GI05MOAS-GL001-00-ENG000000
# Ingest.flord-m-glider_telemetered      /omc_data/whoi/OMC/GI05MOAS-GL001/D00001/merged-from-glider/cp_469_*.mrg GI05MOAS-GL001-01-FLORDM000
# Ingest.dosta-abcdjm-glider_telemetered /omc_data/whoi/OMC/GI05MOAS-GL001/D00001/merged-from-glider/cp_469_*.mrg GI05MOAS-GL001-02-DOSTAM000
# Ingest.ctdgv-m-glider_telemetered      /omc_data/whoi/OMC/GI05MOAS-GL001/D00001/merged-from-glider/cp_469_*.mrg GI05MOAS-GL001-04-CTDGVM000
#
# Ingest.glider-eng-glider_telemetered   /omc_data/whoi/OMC/GI05MOAS-GL002/D00001/merged-from-glider/cp_477_*.mrg GI05MOAS-GL002-00-ENG000000
# Ingest.flord-m-glider_telemetered      /omc_data/whoi/OMC/GI05MOAS-GL002/D00001/merged-from-glider/cp_477_*.mrg GI05MOAS-GL002-01-FLORDM000
# Ingest.dosta-abcdjm-glider_telemetered /omc_data/whoi/OMC/GI05MOAS-GL002/D00001/merged-from-glider/cp_477_*.mrg GI05MOAS-GL002-02-DOSTAM000
# Ingest.ctdgv-m-glider_telemetered      /omc_data/whoi/OMC/GI05MOAS-GL002/D00001/merged-from-glider/cp_477_*.mrg GI05MOAS-GL002-04-CTDGVM000
#
# Ingest.glider-eng-glider_telemetered   /omc_data/whoi/OMC/GI05MOAS-GL003/D00001/merged-from-glider/cp_478_*.mrg GI05MOAS-GL003-00-ENG000000
# Ingest.flord-m-glider_telemetered      /omc_data/whoi/OMC/GI05MOAS-GL003/D00001/merged-from-glider/cp_478_*.mrg GI05MOAS-GL003-01-FLORDM000
# Ingest.dosta-abcdjm-glider_telemetered /omc_data/whoi/OMC/GI05MOAS-GL003/D00001/merged-from-glider/cp_478_*.mrg GI05MOAS-GL003-02-DOSTAM000
# Ingest.ctdgv-m-glider_telemetered      /omc_data/whoi/OMC/GI05MOAS-GL003/D00001/merged-from-glider/cp_478_*.mrg GI05MOAS-GL003-04-CTDGVM000
#
...
GL1D2_files=$(find $GL1D2 -mmin -600 -print)

GL2D2_files=$(find $GL2D2 -mmin -600 -print)
#
GL3D2_files=$(find $GL3D2 -mmin -600 -print)
...
do
    ...
    if  grep --quiet $g2d2 $EDEXLOGFILES; then
       ...
       for i in {0..3}
       do
#           echo "$INGS ${UFR[i]} $g2d2 ${GL2REFDES[i]} telemetered" >> $INGESTLOGT

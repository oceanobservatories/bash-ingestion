...
#Files of the type:
DAT_ADC=/omc_data/whoi/OMC/GP03FLMA/D00002/*adcps*.dat
DAT_CTD=/omc_data/whoi/OMC/GP03FLMA/D00002/*ctdmo*.dat
DAT_DOS=/omc_data/whoi/OMC/GP03FLMA/D00002/*dosta*.dat
DAT_FLO=/omc_data/whoi/OMC/GP03FLMA/D00002/*flort*.dat
DAT_PHS=/omc_data/whoi/OMC/GP03FLMA/D00002/*phsen*.dat
DAT_STA=/omc_data/whoi/OMC/GP03FLMA/D00002/*status_1*.dat
...
do
    if  grep --quiet $files $EDEXLOGFILES; then
        ...
        ls -l $files
        echo $INGS Ingest.ctdmo-ghqr-sio_telemetered $files GP03FLMA-xxxxx-03-CTDMOx000 telemetered
             $INGS Ingest.ctdmo-ghqr-sio_telemetered $files GP03FLMA-xxxxx-03-CTDMOx000 telemetered
        sleep 3
    fi
done

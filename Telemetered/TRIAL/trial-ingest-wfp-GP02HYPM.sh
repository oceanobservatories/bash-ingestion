...
#Files of the type:
#DAT_CTD=/omc_data/whoi/OMC/GP02HYPM/D00002/node*p1_*.ctdmo.dat #no files yet!!!!
...
DAT_WFP_WA_files=$(ls $DAT_WFP_WA|head -250 )
DAT_WFP_WC_files=$(ls $DAT_WFP_WC|head -250 )
DAT_WFP_WE_files=$(ls $DAT_WFP_WE|head -250 )

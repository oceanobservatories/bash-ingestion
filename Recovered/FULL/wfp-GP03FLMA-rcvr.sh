...
HEX_SBE=/omc_data/whoi/OMC/GP03FLMA/R00001/mc/SBE37*.hex
...
do
    if  grep --quiet $files $EDEXLOGFILES; then
        ...
        ls -l $files
        echo $INGS Ingest.ctdmo-ghqr_recovered $files GP03FLMA-xxxxx-03-CTDMOx000 recovered
             $INGS Ingest.ctdmo-ghqr_recovered $files GP03FLMA-xxxxx-03-CTDMOx000 recovered
        sleep 3
    fi
done
